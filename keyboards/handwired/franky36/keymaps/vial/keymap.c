...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x5_3(
        ...
        KC_SFT_Z, KC_X, KC_C,       KC_V,       KC_B,       KC_N,        KC_M,       KC_COMM,   KC_DOT, KC_SFT_SL,
                        KC_OSM_MEH, KC_CMD_TAB, KC_LWR_SPC, KC_RSE_BSPC, KC_CMD_ENT, KC_OSM_CTL
    ),
    ...
    [_LOWER] = LAYOUT_split_3x5_3(
        ...
        KC_GRV,  KC_TILD, KC_PIPE, KC_LPRN, KC_RPRN, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR,
        KC_LSFT, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______, KC_QUOT,
    ...
    [_RAISE] = LAYOUT_split_3x5_3(
        ...
        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, _______, KC_BSLS,
                          _______, _______, _______, _______, _______, _______
    ),
